hello.html:
	mkdir -p build/emcc
	mkdir -p lib/emcc
	em++ -o build/emcc/main.o -c -O3 -flto -g4 -DES_NO_MUSIC -DES_NO_THREADS -DES_GLES -s DISABLE_EXCEPTION_CATCHING=0 -s USE_SDL=2 -s USE_LIBPNG=1 -s USE_LIBJPEG=1 -s USE_WEBGL2=1 -s ASSERTIONS=2 -s DEMANGLE_SUPPORT=1 -s GL_ASSERTIONS=1 -s MIN_WEBGL_VERSION=2 -s EMULATE_FUNCTION_POINTER_CASTS=1 -s FETCH=1 source/main.cpp
